        ...
        <SafeAreaProvider>
            <ThemeProvider theme={theme}>
                {selectedView === "formview" ? (
                    <FormView
                        title="FormView Showcase"
                        onBack={() => setSelectedView("components")}
                        footer={
                            <View style={{ gap: spacing.md }}>
                                <Button variant="primary" size="lg" onPress={() => console.log("Submitted!")}>
                                    Submit Form
                                </Button>
                                <Button variant="ghost" onPress={() => setSelectedView("components")}>
                                    Cancel
                                </Button>
                            </View>
                        }
                    >
                        <Text variant="body" color="secondary" style={{ marginBottom: spacing.lg }}>
                            The FormView component provides a standardized layout for forms with a header, scrollable content area, and a sticky footer. This showcase demonstrates
                        ...
                        <View style={styles.inputSpacer} />
                        <Input label="Bio" placeholder="Tell us about yourself" multiline numberOfLines={4} textAlignVertical="top" style={{ height: 100 }} />
                    </FormView>
                ) : (
                        ...
                        <Section title="Navigation">
                            <SegmentedControl
                                segments={[
                                    ...
                                    { value: "formview", label: "Form View", icon: "layers-outline" },
                                ]}
                                value={selectedView}
