...
import { Badge, Button, defaultDarkTheme, defaultTheme, DynamicStatusBar, Input, PasswordInput, SegmentedControl, spacing, Text, Theme, ThemeProvider } from "@robin-ux/native";
        ...
        <SafeAreaProvider>
            <ThemeProvider theme={theme}>
                <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
                    <DynamicStatusBar scrollY={scrollY} threshold={100} />
                    ...
                    >
                        ...
                        <View style={styles.header}>
                            <Text variant="heading">@robin-ux/native</Text>
